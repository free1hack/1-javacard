...
public class ServiceAdmin   implements Runnable  {
    ...
    private static HashMap<String, ArrayList<ServiceAdmin>> chatGroups = new HashMap<>();
    private static HashMap<String, ArrayList<ServiceAdmin>> socketUser = new HashMap<>(); //String = user_name, ArrayList<Service>= list of socket ID of the same user
    private static List<String> userList = new ArrayList<String>(); //list of connected users
    private static List<ServiceAdmin> allsockets = new ArrayList<ServiceAdmin>(); // comme ArrayList<Service>
    private static Map<String, String> userAuth = new HashMap<>();//Hash MAP containing login and passwords of all users.
    ...
    //For Admin
    public ServiceAdmin() throws IOException {
    ...
    */
    ...
    private void userLogin() throws IOException {
        ...
        ArrayList<ServiceAdmin> socketId = socketUser.get(name);
    ...
    private synchronized boolean isMaxNumberOfConnectedUsersReached() throws IOException{
        ...
        if (ServiceAdmin.userList.size() >= nbUserMax){
    ...
    private void adminMainLoop() throws IOException {
        while (true) {            
            ...
            if(input.equals("msgTo") ||  input.equals("1")){
                ...
                ArrayList<ServiceAdmin> socketId2 = socketUser.get(input);
                while(true){ 
                    input = this.in.nextLine().trim();
                    if (input.equals("quit"))
                   {
                        ...
                        for (ServiceAdmin client : socketId2) {
            ...
            if(input.equals("msgAll") ||  input.equals("2")){
                ...
                while(true){ 
                    ...
                    if (input.equals("quit")){   
                        ...
                        for (ServiceAdmin client : allsockets) {
                            client.sendMessage(name + ": " + input);
                        }     
                    }//end else 
            ...
            if(input.equals("list") ||  input.equals("3")){
                ...
                */
                userListStatus = loadUserListStatus(Service.userList ,Service.userAuth);
    ...
    private synchronized void userFileHandler() throws IOException {
        ...
        while (true){ 
            ...
            ArrayList<ServiceAdmin> socketId2 = socketUser.get(recieverName);
            ...
            //} //End if (this.isRecieverConnected) 
               ...
               // while ((endSendingFile = in.readLine()) == null){    
                ...
                ArrayList<ServiceAdmin> socketId3 = socketUser.get(recieverName);
                for (ServiceAdmin client : socketId3) {
    ...
    private void chatGroupHandler(HashMap<String, ArrayList<ServiceAdmin>> chatGroups2) throws IOException {
        String groupName;
        ...
        ArrayList<ServiceAdmin> groupList = chatGroups.get(groupName);
        ...
        while (true){ 
            ...
            for (ServiceAdmin usr : groupList) {
    ...
    private String getUserName(HashMap<String, ArrayList<ServiceAdmin>> socketUser2) {
        String userName= "" ;        
        for(Entry<String, ArrayList<ServiceAdmin>> index : socketUser2.entrySet()){
                    String user = index.getKey();
                    ArrayList<ServiceAdmin> value = index.getValue();
            for (ServiceAdmin client : value) {
